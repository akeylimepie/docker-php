...
![](https://img.shields.io/badge/-8.5.4-informational) ![](https://img.shields.io/badge/-8.4.19-informational) ![](https://img.shields.io/badge/-8.3.30-informational) ![](https://img.shields.io/badge/-8.2.30-informational) 
...
|-------------------------------------------------|---------|----------|---------|----------|
| Composer `2.9.5`                 | &check; | &check;  | &check; | &check;  |
| Xdebug `3.5.1`                     | &check; |          | &check; |          |
| PHPStan `2.1.42`                   | &check; |          | &check; |          |
| APCu `5.1.28`                         | &check; | &check;  | &check; | &check;  |
| AMQP `2.2.0`                         | &check; | &check;  | &check; | &check;  |
| Relay `0.20.0`                       | &check; | &check;  | &check; | &check;  |
